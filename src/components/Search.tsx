        ...
        <div title="Search" className={`bg-transparent p-[calc(0.6vw+0.4rem)]
            ...
            <div className="flex flex-row items-center justify-end">
                <input type="text" placeholder='What are you looking for?'
                    className={`h-auto w-[calc(11.8vw+8.2rem)] border-2 border-[#CFD8DC] rounded-4xl outline-0 px-[calc(0.6vw+0.4rem)] py-[calc(0.4vw+0.2rem)] pr-[calc(1.6vw+1.2rem)] cursor-pointer text-[calc(0.6vw+0.3rem)] placeholder-[var(--placeholder-color)]`}/>
